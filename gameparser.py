...
def normalise_input(user_input):
    ...
    """
    # Remove spaces 
    remove_spaces = user_input.strip()

    # Remove punctuation and convert to lower case
    
    no_punct = remove_punct(remove_spaces.lower())
    
    # Seperate words by comas
    create_list = no_punct.split()
    filtered_words = filter_words(create_list, skip_words)
